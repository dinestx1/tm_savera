...
const { adminCompanyRouter } = require('./routes/adminCompany.routes')
const { userCompanyRouter } = require('./routes/userCompany.routes')
app.use('/', authRouter)
app.use('/auth/company', adminCompanyRouter)
app.use('/company', userCompanyRouter)
